/**
 * MyMQTT Broker Gateway modified to use with RFM69 radio module
 * Modified (Aug 2015) by Grzegorz Miasko <gieemek@wp.pl>
 */
/**
...
bool isRFM69HW = true;  // Set it to false if you use RFM69W
